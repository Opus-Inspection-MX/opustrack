...
import { AlertTriangle, Briefcase, Mail, Phone, User } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {isOwnProfile ? "My Profile Details" : "User Profile Details"}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("secondaryTelephone", e.target.value)
                    }
                    onBlur={() => handleBlur("secondaryTelephone")}
                    placeholder="+1-555-0124"
                    className={
                      errors.secondaryTelephone ? "border-red-500" : ""
                    }
                  />
                  {errors.secondaryTelephone && (
                    <FormError message={errors.secondaryTelephone} />
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.emergencyContact && (
                  <FormError message={errors.emergencyContact} />
                )}
                <p className="text-xs text-muted-foreground">
                  Include name and phone number of emergency contact
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                {errors.jobPosition && (
                  <FormError message={errors.jobPosition} />
                )}
              </div>
            </div>
