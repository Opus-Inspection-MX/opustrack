...
const vicCenterSchema = z.object({
  ...
  lines: z
    .number()
    .min(1, "Must have at least 1 line")
    .max(20, "Cannot have more than 20 lines"),
...
export function VICCenterForm({
  ...
  const [states, _setStates] = useState<State[]>(mockStates);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        isEditing ? "Update VIC center:" : "Create VIC center:",
        validatedData,
      );
  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>
          {isEditing ? "Edit VIC Center" : "Create New VIC Center"}
        </CardTitle>
        <CardDescription>
          {isEditing
            ? "Update VIC center information"
            : "Add a new Vehicle Inspection Center to the system"}
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("stateId", Number.parseInt(value, 10))
                  }
                >
                  <SelectTrigger
