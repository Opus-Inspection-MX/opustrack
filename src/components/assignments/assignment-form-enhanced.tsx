...
interface AssignmentFormEnhancedProps {
...
export function AssignmentFormEnhanced({
  assignment,
  incident,
  onClose,
  ...
  useEffect(() => {
    if (assignment) {
      ...
      setWorkParts(assignment.workParts || []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Submitting asignación:", submitData);
      await new Promise((resolve) => setTimeout(resolve, 1000));

      alert(
        assignment
          ? "Asignación updated successfully!"
          : "Asignación created successfully!",
      );
