    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <BackButton fallback="/admin/settings/vehicle-trip-status" />
          <div>
            <h1 className="text-3xl font-bold">{status.name}</h1>
            <p className="text-muted-foreground">Vehicle trip status details</p>
          </div>
        </div>
        <Link href={`/admin/settings/vehicle-trip-status/${status.id}/edit`}>
          <Button>
