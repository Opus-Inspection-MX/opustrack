...
import type { AgingSummary, WorkOrderAgingData } from "@/lib/actions/reports";
import { getWorkOrderAgingData } from "@/lib/actions/reports";

interface WorkOrderAgingClientProps {
  initialData: {
...
export function WorkOrderAgingClient({
  initialData,
}: WorkOrderAgingClientProps) {
  ...
  const handleRefresh = () => {
    startTransition(async () => {
      const result = await getWorkOrderAgingData();
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Ordenes de trabajo abiertas clasificadas por tiempo sin resolver.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={`${summary.oldestWorkOrder} dias`}
      ...
      {/* Warning Banner for old work orders */}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                ...
                ordenes de trabajo con mas de 60 dias sin resolver. Estas
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <ChartCard
          ...
          description="Cantidad de ordenes en cada rango de antiguedad"
        >
      ...
      <ChartCard
        ...
        description="Desglose de ordenes por tiempo de antiguedad"
      >
      ...
      <ChartCard
        ...
        description="Todas las ordenes pendientes ordenadas por antiguedad"
      >
            ...
            <TableBody>
              ...
              {data.length === 0 && (
                <TableRow>
                  ...
                  >
                    No hay ordenes de trabajo abiertas
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
