...
ALTER TABLE "assignments" DROP COLUMN "folio";
...
CREATE UNIQUE INDEX "Assignment_folio_key" ON "assignments"("folio");

-- 6. Tie the sequence's ownership to the column so it's dropped if the column ever is
ALTER SEQUENCE "assignment_folio_seq" OWNED BY "assignments"."folio";
